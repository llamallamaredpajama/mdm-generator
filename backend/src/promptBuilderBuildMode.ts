...
export function buildSection1Prompt(
  ...
  const user = [
    ...
    '  "societyGuidelines": [',
    '    {',
    '      "source": "Issuing society (e.g., AHA/ACC 2024, ACEP, AHA/ASA, EAST)",',
    '      "title": "Guideline name",',
    '      "relevance": "Why this guideline is relevant to this specific presentation"',
    '    }',
    photoCatalog ? '  ],' : '  ]',
    ...(photoCatalog ? [
    ...
    '4. SOCIETY GUIDELINES: Identify 1-5 relevant EM society guidelines for this presentation.',
    '   - Consider: ACEP clinical policies, AHA/ACC (cardiac), AHA/ASA (stroke), EAST (trauma), ATLS, ACOG (OB/GYN), AAP/PECARN (pediatric), TBI guidelines.',
    '   - Each guideline should explain why it is relevant to THIS specific case.',
    '   - If no major society guidelines apply, return an empty array.',
    ...(photoCatalog ? [
      '',
      photoCatalog,
