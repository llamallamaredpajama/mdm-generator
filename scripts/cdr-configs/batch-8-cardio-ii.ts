...
export const batch8CardioIiCdrs: CdrSeed[] = [
  ...
  // ---------------------------------------------------------------------------
  // ESC High-Sensitivity Troponin Algorithm
  // Algorithm-based: 0/1-hour or 0/3-hour hs-cTn pathway
  // ---------------------------------------------------------------------------
  {
    id: 'esc_hs_troponin',
  ...
  // ---------------------------------------------------------------------------
  // FAINT Score
  // Sum-based: 5 weighted criteria for vasovagal vs cardiac syncope
  // ---------------------------------------------------------------------------
  {
    id: 'faint_score',
    name: 'FAINT Score',
