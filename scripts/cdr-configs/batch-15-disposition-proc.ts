...
export const batch15DispositionProcCdrs: CdrSeed[] = [
  ...
  // ---------------------------------------------------------------------------
  // MELD Score — QUARANTINED
  // Moved to _quarantine/meld.ts
  // Reason: All 3 components are lab-based (section2); 0 user-answerable components.
  // ---------------------------------------------------------------------------

  // ---------------------------------------------------------------------------
  // Child-Pugh Score — QUARANTINED
  // Moved to _quarantine/child_pugh.ts
  // Reason: Only 2 of 5 components are section1 (ascites, encephalopathy);
  // published source has no 3rd clinical component.
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  // ASA Physical Status Classification — QUARANTINED
  // Moved to _quarantine/asa_classification.ts
  // Reason: Single-component ordinal scale. Published source does not support
  // decomposition into multiple independently scoreable domains.
  // ---------------------------------------------------------------------------
]
