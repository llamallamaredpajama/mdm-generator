...
const tests: TestSeed[] = [
  ...
  { id: 'rapid_strep', name: 'Rapid Strep', category: 'procedures_poc', subcategory: 'point_of_care', commonIndications: ['sore throat', 'pharyngitis'], unit: null, normalRange: null, quickFindings: ['Positive', 'Negative'], feedsCdrs: ['centor'] },
