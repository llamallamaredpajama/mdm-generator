...
const tests: TestSeed[] = [
  ...
  { id: 'gi_pathogen_panel', name: 'GI Pathogen Panel (PCR)', category: 'labs', subcategory: 'infectious', commonIndications: ['acute gastroenteritis', 'bloody diarrhea', 'traveler diarrhea', 'immunocompromised with diarrhea', 'food poisoning', 'prolonged diarrhea'], unit: null, normalRange: null, quickFindings: ['C. difficile positive', 'Campylobacter positive', 'Salmonella positive', 'Norovirus positive', 'Shigella/EIEC positive', 'STEC/E. coli O157 positive', 'Giardia positive', 'Rotavirus positive', 'Negative (no pathogens detected)'], feedsCdrs: [] },
  { id: 'respiratory_panel', name: 'Respiratory Pathogen Panel (PCR)', category: 'labs', subcategory: 'infectious', commonIndications: ['respiratory illness', 'fever', 'pneumonia', 'bronchiolitis', 'immunocompromised', 'upper respiratory infection', 'coinfection evaluation'], unit: null, normalRange: null, quickFindings: ['Influenza A', 'Influenza B', 'RSV', 'SARS-CoV-2', 'Rhinovirus/Enterovirus', 'Adenovirus', 'Parainfluenza', 'Metapneumovirus', 'Coronavirus (seasonal)', 'Bordetella pertussis', 'Mycoplasma pneumoniae', 'Negative'], feedsCdrs: [] },
  ...
  // ===== IMAGING =====
  { id: 'ct_head', name: 'CT Head', category: 'imaging', subcategory: 'ct', commonIndications: ['headache', 'trauma', 'altered mental status', 'stroke'], unit: null, normalRange: null, quickFindings: ['Normal', 'Bleed', 'Mass', 'Edema', 'Midline shift'], feedsCdrs: ['canadian_ct_head'] },
  { id: 'ct_cspine', name: 'CT C-spine', category: 'imaging', subcategory: 'ct', commonIndications: ['trauma', 'neck pain', 'neurologic deficit'], unit: null, normalRange: null, quickFindings: ['Normal', 'Fracture', 'Subluxation', 'Degenerative'], feedsCdrs: ['nexus', 'canadian_cspine'] },
  { id: 'ct_chest', name: 'CT Chest', category: 'imaging', subcategory: 'ct', commonIndications: ['chest pain', 'dyspnea', 'trauma'], unit: null, normalRange: null, quickFindings: ['Normal', 'Consolidation', 'Effusion', 'Mass', 'Fracture'], feedsCdrs: [] },
  { id: 'cta_chest', name: 'CTA Chest', category: 'imaging', subcategory: 'ct', commonIndications: ['PE', 'aortic dissection', 'chest pain'], unit: null, normalRange: null, quickFindings: ['Normal', 'PE', 'Aortic dissection', 'Aneurysm'], feedsCdrs: ['wells_pe', 'perc'] },
  { id: 'ct_abd_pelv', name: 'CT Abdomen/Pelvis', category: 'imaging', subcategory: 'ct', commonIndications: ['abdominal pain', 'appendicitis', 'obstruction'], unit: null, normalRange: null, quickFindings: ['Normal', 'Appendicitis', 'Obstruction', 'Free fluid', 'Mass'], feedsCdrs: [] },
  { id: 'cta_head', name: 'CTA Head/Neck', category: 'imaging', subcategory: 'ct', commonIndications: ['stroke', 'vessel occlusion', 'dissection'], unit: null, normalRange: null, quickFindings: ['Normal', 'Occlusion', 'Stenosis', 'Aneurysm', 'Dissection'], feedsCdrs: [] },
  { id: 'xr_chest', name: 'Chest X-ray (CXR)', category: 'imaging', subcategory: 'xray', commonIndications: ['dyspnea', 'cough', 'chest pain', 'fever'], unit: null, normalRange: null, quickFindings: ['Normal', 'Infiltrate', 'Effusion', 'Pneumothorax', 'Cardiomegaly'], feedsCdrs: [] },
  { id: 'xr_ext', name: 'X-ray Extremity', category: 'imaging', subcategory: 'xray', commonIndications: ['injury', 'pain', 'deformity'], unit: null, normalRange: null, quickFindings: ['Normal', 'Fracture', 'Dislocation', 'Soft tissue swelling'], feedsCdrs: ['ottawa_ankle', 'ottawa_knee'] },
  { id: 'xr_spine', name: 'X-ray Spine', category: 'imaging', subcategory: 'xray', commonIndications: ['back pain', 'trauma', 'compression fracture'], unit: null, normalRange: null, quickFindings: ['Normal', 'Fracture', 'Compression', 'Degenerative'], feedsCdrs: [] },
  { id: 'us_fast', name: 'US FAST', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['trauma', 'hypotension', 'abdominal pain'], unit: null, normalRange: null, quickFindings: ['Negative', 'Positive - free fluid', 'Positive - pericardial'], feedsCdrs: [] },
  { id: 'us_ruq', name: 'US RUQ (Gallbladder)', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['RUQ pain', 'cholecystitis', 'biliary disease'], unit: null, normalRange: null, quickFindings: ['Normal', 'Cholelithiasis', 'Cholecystitis', 'CBD dilation'], feedsCdrs: [] },
  { id: 'us_aorta', name: 'US Aorta', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['abdominal pain', 'AAA screening', 'hypotension'], unit: null, normalRange: null, quickFindings: ['Normal', 'AAA', 'Dissection flap'], feedsCdrs: [] },
  { id: 'us_soft_tissue', name: 'US Soft Tissue', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['abscess', 'cellulitis', 'foreign body'], unit: null, normalRange: null, quickFindings: ['Normal', 'Abscess', 'Cellulitis', 'Foreign body'], feedsCdrs: [] },
  { id: 'us_ob', name: 'US OB (Obstetric)', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['pregnancy', 'vaginal bleeding', 'abdominal pain'], unit: null, normalRange: null, quickFindings: ['IUP confirmed', 'No IUP', 'Ectopic', 'Free fluid'], feedsCdrs: [] },
  { id: 'us_renal', name: 'US Renal', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['flank pain', 'renal colic', 'hematuria'], unit: null, normalRange: null, quickFindings: ['Normal', 'Hydronephrosis', 'Stone', 'Mass'], feedsCdrs: [] },
  { id: 'echo_tte', name: 'Echo TTE', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['dyspnea', 'chest pain', 'murmur', 'CHF'], unit: null, normalRange: null, quickFindings: ['Normal EF', 'Reduced EF', 'Wall motion abnormality', 'Pericardial effusion', 'Valve abnormality'], feedsCdrs: ['heart'] },
  { id: 'us_le_venous', name: 'LE Venous Duplex (DVT)', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['DVT', 'leg swelling', 'unilateral edema'], unit: null, normalRange: null, quickFindings: ['Normal', 'DVT present', 'Superficial thrombosis'], feedsCdrs: ['wells_dvt'] },
  { id: 'us_pelvic', name: 'Pelvic Ultrasound', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['ectopic pregnancy', 'ovarian torsion', 'pelvic pain', 'vaginal bleeding'], unit: null, normalRange: null, quickFindings: ['Normal', 'Free fluid', 'Ovarian mass', 'Ectopic'], feedsCdrs: [] },
  { id: 'cta_abd', name: 'CTA Abdomen/Pelvis', category: 'imaging', subcategory: 'ct', commonIndications: ['mesenteric ischemia', 'AAA', 'GI bleed', 'vascular emergency'], unit: null, normalRange: null, quickFindings: ['Normal', 'Mesenteric occlusion', 'AAA', 'Active extravasation'], feedsCdrs: [] },
  { id: 'xr_pelvis', name: 'X-ray Pelvis', category: 'imaging', subcategory: 'xray', commonIndications: ['hip fracture', 'pelvic trauma', 'hip pain'], unit: null, normalRange: null, quickFindings: ['Normal', 'Fracture', 'Dislocation', 'Degenerative'], feedsCdrs: [] },
  { id: 'ct_face', name: 'CT Facial Bones', category: 'imaging', subcategory: 'ct', commonIndications: ['facial trauma', 'orbital fracture', 'midface fracture'], unit: null, normalRange: null, quickFindings: ['Normal', 'Orbital fracture', 'Nasal fracture', 'Le Fort fracture'], feedsCdrs: [] },
  { id: 'xr_abd', name: 'X-ray Abdomen (KUB)', category: 'imaging', subcategory: 'xray', commonIndications: ['obstruction', 'foreign body', 'constipation', 'kidney stone'], unit: null, normalRange: null, quickFindings: ['Normal', 'Obstruction', 'Free air', 'Calcification'], feedsCdrs: [] },

  // New head_neck imaging
  { id: 'ct_neck_soft', name: 'CT Neck Soft Tissue', category: 'imaging', subcategory: 'ct', commonIndications: ['peritonsillar abscess', 'retropharyngeal abscess', 'Ludwig angina', 'deep neck space infection', 'neck mass'], unit: null, normalRange: null, quickFindings: ['Normal', 'Peritonsillar abscess', 'Retropharyngeal abscess', 'Lymphadenopathy', 'Mass'], feedsCdrs: [] },
  { id: 'xr_neck_soft', name: 'X-ray Soft Tissue Neck', category: 'imaging', subcategory: 'xray', commonIndications: ['croup', 'epiglottitis', 'foreign body', 'retropharyngeal abscess'], unit: null, normalRange: null, quickFindings: ['Normal', 'Steeple sign (croup)', 'Thumbprint sign (epiglottitis)', 'Prevertebral widening', 'Foreign body'], feedsCdrs: [] },
  { id: 'ct_orbits', name: 'CT Orbits', category: 'imaging', subcategory: 'ct', commonIndications: ['orbital cellulitis', 'orbital abscess', 'globe rupture', 'retrobulbar hemorrhage'], unit: null, normalRange: null, quickFindings: ['Normal', 'Orbital cellulitis', 'Subperiosteal abscess', 'Retrobulbar hemorrhage', 'Foreign body'], feedsCdrs: [] },
  { id: 'ct_sinuses', name: 'CT Sinuses', category: 'imaging', subcategory: 'ct', commonIndications: ['sinusitis', 'orbital cellulitis', 'facial pain', 'periorbital swelling'], unit: null, normalRange: null, quickFindings: ['Normal', 'Sinus opacification', 'Air-fluid levels', 'Mucosal thickening', 'Orbital extension'], feedsCdrs: [] },
  { id: 'panorex', name: 'Panoramic Dental X-ray (Panorex)', category: 'imaging', subcategory: 'xray', commonIndications: ['mandible fracture', 'dental trauma', 'dental abscess', 'TMJ evaluation'], unit: null, normalRange: null, quickFindings: ['Normal', 'Mandible fracture', 'Dental fracture', 'Periapical abscess', 'TMJ abnormality'], feedsCdrs: [] },
  { id: 'us_ocular', name: 'Ocular Ultrasound', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['retinal detachment', 'vitreous hemorrhage', 'lens dislocation', 'elevated IOP concern', 'globe rupture'], unit: null, normalRange: null, quickFindings: ['Normal', 'Retinal detachment', 'Vitreous hemorrhage', 'Lens dislocation', 'Posterior vitreous detachment'], feedsCdrs: [] },

  // New chest imaging
  { id: 'vq_scan', name: 'V/Q Scan', category: 'imaging', subcategory: 'nuclear_medicine', commonIndications: ['PE (CTA contraindicated)', 'renal insufficiency', 'contrast allergy', 'pregnancy'], unit: null, normalRange: null, quickFindings: ['Normal', 'Low probability', 'Intermediate probability', 'High probability'], feedsCdrs: ['wells_pe'] },
  { id: 'us_lung', name: 'US Lung (POCUS)', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['dyspnea', 'pneumothorax', 'pleural effusion', 'pulmonary edema', 'pneumonia'], unit: null, normalRange: null, quickFindings: ['A-lines (normal/COPD)', 'B-lines (pulmonary edema)', 'Absent lung sliding (pneumothorax)', 'Effusion', 'Consolidation (hepatization)'], feedsCdrs: [] },
  { id: 'xr_ribs', name: 'X-ray Ribs', category: 'imaging', subcategory: 'xray', commonIndications: ['chest wall pain', 'trauma', 'rib fracture', 'flail chest'], unit: null, normalRange: null, quickFindings: ['Normal', 'Single rib fracture', 'Multiple rib fractures', 'Flail segment'], feedsCdrs: [] },

  // New extremity imaging
  { id: 'ct_extremity', name: 'CT Extremity', category: 'imaging', subcategory: 'ct', commonIndications: ['occult fracture', 'complex fracture', 'calcaneus fracture', 'tibial plateau fracture'], unit: null, normalRange: null, quickFindings: ['Normal', 'Occult fracture', 'Comminuted fracture', 'Intra-articular extension', 'Foreign body'], feedsCdrs: [] },

  // New spine imaging
  { id: 'ct_tl_spine', name: 'CT Thoracolumbar Spine', category: 'imaging', subcategory: 'ct', commonIndications: ['trauma', 'back pain', 'compression fracture', 'neurologic deficit'], unit: null, normalRange: null, quickFindings: ['Normal', 'Compression fracture', 'Burst fracture', 'Transverse process fracture', 'Degenerative'], feedsCdrs: [] },

  // New cardiac imaging
  { id: 'us_ivc', name: 'US IVC (Volume Assessment)', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['volume status assessment', 'hypotension', 'sepsis', 'fluid responsiveness'], unit: null, normalRange: null, quickFindings: ['Plethoric (>2.1cm, <50% collapse)', 'Normal', 'Flat/collapsing (volume responsive)', 'IVC >50% collapse with respiration'], feedsCdrs: ['sepsis'] },

  // New genitourinary imaging
  { id: 'us_testicular', name: 'US Testicular/Scrotal', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['testicular torsion', 'scrotal pain', 'testicular mass', 'epididymitis'], unit: null, normalRange: null, quickFindings: ['Normal', 'Torsion (absent flow)', 'Epididymitis', 'Hydrocele', 'Mass'], feedsCdrs: [] },

  // New vascular imaging
  { id: 'us_ue_venous', name: 'UE Venous Duplex', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['upper extremity DVT', 'arm swelling', 'PICC-associated thrombosis', 'catheter-related thrombosis'], unit: null, normalRange: null, quickFindings: ['Normal', 'DVT present', 'Superficial thrombosis'], feedsCdrs: [] },
  { id: 'us_carotid', name: 'Carotid Duplex', category: 'imaging', subcategory: 'ultrasound', commonIndications: ['TIA', 'stroke', 'carotid bruit', 'amaurosis fugax'], unit: null, normalRange: null, quickFindings: ['Normal', 'Stenosis <50%', 'Stenosis 50-69%', 'Stenosis 70-99%', 'Occlusion'], feedsCdrs: ['abcd2'] },
  { id: 'ct_angio_chest_abd', name: 'CTA Chest/Abdomen/Pelvis', category: 'imaging', subcategory: 'ct', commonIndications: ['aortic dissection', 'polytrauma', 'ruptured AAA', 'aortic emergency'], unit: null, normalRange: null, quickFindings: ['Normal', 'Aortic dissection Type A', 'Aortic dissection Type B', 'AAA with rupture', 'Active hemorrhage'], feedsCdrs: [] },
  { id: 'ct_angio_extremity', name: 'CTA Extremity', category: 'imaging', subcategory: 'ct', commonIndications: ['vascular injury', 'limb ischemia', 'penetrating extremity trauma', 'absent distal pulses'], unit: null, normalRange: null, quickFindings: ['Normal vasculature', 'Vessel occlusion', 'Active extravasation', 'Pseudoaneurysm', 'AV fistula'], feedsCdrs: [] },

  // New gastrointestinal imaging
  { id: 'swallow_study', name: 'Esophagram/Swallow Study', category: 'imaging', subcategory: 'fluoroscopy', commonIndications: ['esophageal foreign body', 'esophageal perforation', 'dysphagia', 'Boerhaave syndrome'], unit: null, normalRange: null, quickFindings: ['Normal', 'Foreign body', 'Perforation/leak', 'Stricture', 'Obstruction'], feedsCdrs: [] },
  { id: 'upper_gi_sbft', name: 'Upper GI with Small Bowel Follow Through', category: 'imaging', subcategory: 'fluoroscopy', commonIndications: ['bilious emesis (pediatric)', 'malrotation', 'midgut volvulus', 'bowel obstruction', 'intermittent abdominal pain'], unit: null, normalRange: null, quickFindings: ['Normal (DJ junction left of spine at pylorus level)', 'Malrotation (ligament of Treitz on right)', 'Corkscrew duodenum (volvulus)', 'Duodenal obstruction (beak sign)', 'Partial obstruction', 'Normal transit time'], feedsCdrs: [] },
  ...
  { id: 'us_guided_piv', name: 'Ultrasound-Guided Peripheral IV', category: 'procedures_poc', subcategory: 'vascular_access', commonIndications: ['difficult IV access', 'obesity', 'IV drug use', 'dehydration', 'ESRD', 'failed blind attempts'], unit: null, normalRange: null, quickFindings: ['Successful first-attempt', 'Long catheter placed (basilic/brachial)', 'Short-axis technique', 'Long-axis technique', 'Multiple attempts required'], feedsCdrs: [] },
  { id: 'ej_iv', name: 'External Jugular IV', category: 'procedures_poc', subcategory: 'vascular_access', commonIndications: ['difficult peripheral access', 'failed peripheral IV', 'emergency vascular access', 'volume resuscitation'], unit: null, normalRange: null, quickFindings: ['Successful cannulation', 'Trendelenburg positioning used', 'Good flow confirmed', 'Dislodged/positional'], feedsCdrs: [] },
  ...
  { id: 'targeted_temp_mgmt', name: 'Targeted Temperature Management', category: 'procedures_poc', subcategory: 'resuscitation', commonIndications: ['post-cardiac arrest', 'ROSC', 'neuroprotection'], unit: null, normalRange: null, quickFindings: ['Cooling initiated', 'Target temp achieved 33°C', 'Target temp achieved 36°C', 'Rewarming phase'], feedsCdrs: [] },
