      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-badge">
            ...
            <span className="badge-item">
              <svg className="badge-icon" viewBox="0 0 24 24" fill="currentColor">
                <path d="M5.121 2.121a1.5 1.5 0 012.121 0 1.5 1.5 0 010 2.122 1.5 1.5 0 01-2.121 0 1.5 1.5 0 010-2.122zm11.757 0a1.5 1.5 0 012.122 0 1.5 1.5 0 010 2.122 1.5 1.5 0 01-2.122 0 1.5 1.5 0 010-2.122zM6.182 4.242c-1.103 0-2 .897-2 2v4.576c0 4.418 3.582 8 8 8s8-3.582 8-8V6.242c0-1.103-.897-2-2-2s-2 .897-2 2v4.576c0 2.209-1.791 4-4 4s-4-1.791-4-4V6.242c0-1.103-.897-2-2-2zm5.818 14.576v1.515c0 1.933 1.567 3.5 3.5 3.5s3.5-1.567 3.5-3.5-1.567-3.5-3.5-3.5c-.966 0-1.75.784-1.75 1.75s.784 1.75 1.75 1.75 1.75-.784 1.75-1.75"/>
              </svg>
